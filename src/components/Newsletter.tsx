          ...
          {subscribed ? (
            ...
            >
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className={`w-full py-4 rounded-xl font-display text-xs tracking-widest font-extrabold uppercase transition-all shadow-lg flex items-center justify-center gap-2 ${
                  isSubmitting
