          ...
          {subscribed ? (
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col gap-5" id="subscribe-form" noValidate>
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full bg-surface-container-lowest border ${
                      error ? "border-red-400 focus:ring-red-400 focus:border-red-400" : "border-outline-variant focus:border-primary focus:ring-1 focus:ring-primary"
                    } rounded-xl pl-11 pr-4 py-3.5 text-on-surface text-sm outline-none transition-all placeholder:text-on-surface-variant/30 font-medium`}
                ...
                {error && (
                  <p id="newsletter-error" role="alert" className="text-[10px] text-red-400 font-bold ml-1 animate-fade-in">
                    * {error}
                  </p>
                )}
              </div>
